...
public class MetaheresSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_ServiceName(ISerializationContext context, ServiceName semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getServiceNameAccess().getNameEStringParserRuleCall_0_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getServiceNameAccess().getServiceconfigServiceConfigParserRuleCall_2_0(), semanticObject.getServiceconfig());
		feeder.finish();
	}
